                    ...
                    <div class="row g-3 lang_form default-form" >
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea id="footer_data" rows="5" maxlength="300"  class="form-control" name="footer_data[]" placeholder="{{translate('messages.Short_Description')}}">{{ $footer_data?->getRawOriginal('value') ?? null}}</textarea>
                            </div>
                        </div>
                    </div>
